...
<div class="row">
	<div class="col-sm-12">
		<div class="well">
			<h4 class="blue smaller lighter"><?php echo $this->Html->link('文章图文', "{$WC_URL}?_m=tw&_a=add"); ?></h4>
			文章类型的单图文展示页面，普通文章，适用公司简介，联系方式等信息的展示。
		</div>
		<div class="well">
			<h4 class="blue smaller lighter"><?php echo $this->Html->link('活动图文', "{$WC_URL}?_m=event&_a=add"); ?></h4>
			活动类型的单图文展示页面，活动详细页展示您定义的活动，有活动报名，成员审核，活动管理等。
		</div>
		<div class="well">
