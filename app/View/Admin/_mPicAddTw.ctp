...
<div class="cl">
    ...
    <?php
        ...
        'div' => "form-group",
        'label' => array('text' => "图文名称：", 'class' => "item-title control-label no-padding-right"),
        'type' => "text",
        'placeholder' => "",
        ...
        'div' => "form-group",
        'label' => array('text' => "作者：", 'class' => "item-title control-label no-padding-right"),
        'type' => "text",
        'placeholder' => "",
        'class' => "col-xs-10 col-sm-8",
        'between' => "<div class='col-xs-12 col-sm-9'><div class='clearfix'>",
        ...
        'div' => "form-group",
        'label' => array('text' => "封面图片：", 'class' => "item-title control-label no-padding-right"),
        'type' => "text",
        'placeholder' => "",
        'class' => "col-xs-10 col-sm-8",
        'between' => "<div class='col-xs-12 col-sm-9'><div class='clearfix'>",
        ...
        'div' => "form-group",
        'label' => array('text' => "摘要：", 'class' => "item-title control-label no-padding-right"),
        'type' => "textarea",
        'placeholder' => "",
        'style' => "width:600px",
        'class' => "col-xs-10 col-sm-8",
        ...
        'div' => "form-group",
        'label' => array('text' => "图文内容：", 'class' => "item-title control-label no-padding-right"),
        'type' => "textarea",
        'placeholder' => "",
        ...
        'div' => "form-group",
        'label' => array('text' => "图文链接：", 'class' => "item-title control-label no-padding-right"),
        'type' => "text",
        'placeholder' => "",
